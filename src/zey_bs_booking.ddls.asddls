...
define view entity ZEY_BS_BOOKING as select from /dmo/booking_m
composition[0..*] of ZEY_BS_BOOKSUPPL as _BookingSupplement
association to parent ZEY_BS_TRAVEL as _Travel on
